<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">برناج الفواتير</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='profile') }}">إضافه قسم</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='editprofile') }}">إضافه منتج</a></li>
						</ul>
					</li>
				</ul>
			</div>
